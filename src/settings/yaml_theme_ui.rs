use iced::{Element, widget::{column, row, text, button, text_input, scrollable, pick_list, container}, Command, Length};
use iced::Color;
...
// Helper to convert TerminalColors to a HashMap for easier iteration
impl TerminalColors {
    fn to_map(&self) -> HashMap<String, String> {
        let mut map = HashMap::new();
        map.insert("background".to_string(), self.background.clone());
        map.insert("foreground".to_string(), self.foreground.clone());
        map.insert("cursor".to_string(), self.cursor.clone());
        map.insert("selection".to_string(), self.selection.clone());
        map.insert("black".to_string(), self.black.clone());
        map.insert("red".to_string(), self.red.clone());
        map.insert("green".to_string(), self.green.clone());
        map.insert("yellow".to_string(), self.yellow.clone());
        map.insert("blue".to_string(), self.blue.clone());
        map.insert("magenta".to_string(), self.magenta.clone());
        map.insert("cyan".to_string(), self.cyan.clone());
        map.insert("white".to_string(), self.white.clone());
        map.insert("bright_black".to_string(), self.bright_black.clone());
        map.insert("bright_red".to_string(), self.bright_red.clone());
        map.insert("bright_green".to_string(), self.bright_green.clone());
        map.insert("bright_yellow".to_string(), self.bright_yellow.clone());
        map.insert("bright_blue".to_string(), self.bright_blue.clone());
        map.insert("bright_magenta".to_string(), self.bright_magenta.clone());
        map.insert("bright_cyan".to_string(), self.bright_cyan.clone());
        map.insert("bright_white".to_string(), self.bright_white.clone());
        map
    }
}

pub fn init() {
    println!("settings/yaml_theme_ui module loaded");
}
